"""
Requirements Demarcator using Llama 3.3 70B Instruct
CSI5187 Assignment 4

Uses Llama 3.3 70B Instruct via OpenRouter API for requirements classification.
"""
...
class RequirementsDemarcatorLlama3:
    """Requirements Demarcator using Llama 3.3 70B Instruct via OpenRouter API."""
...
def main():
    ...
    print("\nInitializing Llama 3.3 70B Instruct...")
    demarcator = RequirementsDemarcatorLlama3(
        api_key=api_key,
    ...
    output_file = os.path.join(script_dir, 'predictions_llama3.csv')
    df_test.to_csv(output_file, index=False)

    # Calculate metrics
    print("\n" + "=" * 80)
    print("FINAL RESULTS - Llama 3.3 70B Instruct")
    print("=" * 80)
    ...
    # Save metrics
    metrics_file = os.path.join(script_dir, 'metrics_llama3.json')
